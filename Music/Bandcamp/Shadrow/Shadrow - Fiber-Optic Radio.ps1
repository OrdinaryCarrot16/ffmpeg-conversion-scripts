...
ffmpeg -ss 00:00:00.000 -to 00:03:39.750 -i "Shadrow - Fiber-Optic Radio - 14 Dr. Gaster (The Groundbreaking Remix).flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow / Ground-Breaking" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune | Remix" -metadata track="14/24" -metadata title="Dr. Gaster (The Ground-Breaking Remix) (Remix)" -af "apad=pad_dur=3s,volume=-3dB" -c:a libvorbis -q 6 -minrate 128k "14 - Dr. Gaster (The Ground-Breaking Remix) (Remix).ogg"
Move-Item -Path "14 - Dr. Gaster (The Ground-Breaking Remix) (Remix).ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
